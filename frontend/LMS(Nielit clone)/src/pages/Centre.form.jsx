...
const Centreform = () => {
  ...
  const submitForm = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch("http://localhost:5000/centre", {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            centreCode,
            centreName,
            centreCity: "Sample City", 
            centerState: stateid,
            centerCountry: countryid, 
          }),
        });
  ...
  return (
    <div className="container d-flex py-3 align-items-center">
      ...
      <div className="card shadow w-50 ">
        <h2 className="text-center my-4 fw-bold">Exam Centre Form</h2>
